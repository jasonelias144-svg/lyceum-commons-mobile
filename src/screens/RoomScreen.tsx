  ...
  const refresh = useCallback(
    async (opts?: { initial?: boolean; forceScroll?: boolean; full?: boolean }) => {
      ...
      try {
        ...
        // Room meta rides on every messages response. Guard turn against stale
        // in-flight polls that started before the latest post, and against older
        // updated_at values overwriting a newer turn from a post response.
